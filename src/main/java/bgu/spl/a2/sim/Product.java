...
public class Product implements Serializable {
	...
	*/
    ...
    /**
     * Sum the useOn value to the total finalId of this product
     * @param useOn - the returned value of Tool's useOn method on this product 
     */
    public synchronized void sumUseOnId(long useOn){
    	finalId += useOn;
    }
